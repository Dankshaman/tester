...
public class UIToggle : UIWidgetContainer
{
	...
	// (get) Token: 0x06000299 RID: 665 RVA: 0x000112C0 File Offset: 0x0000F4C0
	// (set) Token: 0x0600029A RID: 666 RVA: 0x000112D7 File Offset: 0x0000F4D7
	public bool value
	{
		get
		{
	...
	// (get) Token: 0x0600029B RID: 667 RVA: 0x00011310 File Offset: 0x0000F510
	...
	// (get) Token: 0x0600029C RID: 668 RVA: 0x0001134C File Offset: 0x0000F54C
	// (set) Token: 0x0600029D RID: 669 RVA: 0x00011354 File Offset: 0x0000F554
	...
	// Token: 0x0600029E RID: 670 RVA: 0x00011360 File Offset: 0x0000F560
	...
	// Token: 0x0600029F RID: 671 RVA: 0x000113AB File Offset: 0x0000F5AB
	private void OnEnable()
	{
		UIToggle.list.Add(this);
	}

	// Token: 0x060002A0 RID: 672 RVA: 0x000113B8 File Offset: 0x0000F5B8
	private void OnDisable()
	{
		UIToggle.list.Remove(this);
	}

	// Token: 0x060002A1 RID: 673 RVA: 0x000113C8 File Offset: 0x0000F5C8
	public void Start()
	{
		if (this.mStarted)
		{
	...
	// Token: 0x060002A2 RID: 674 RVA: 0x00011502 File Offset: 0x0000F702
	...
	// Token: 0x060002A3 RID: 675 RVA: 0x0001152C File Offset: 0x0000F72C
	...
	// Token: 0x060002A4 RID: 676 RVA: 0x000118A4 File Offset: 0x0000FAA4
	public void OverrideSet(bool state)
	{
		if (this.activeSprite != null)
		{
			...
			{
				TweenAlpha.Begin(this.activeSprite.gameObject, 0.15f, this.mIsActive ? 1f : 0f, 0f);
			}
		}
